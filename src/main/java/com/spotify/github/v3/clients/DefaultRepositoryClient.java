...
public class DefaultRepositoryClient implements RepositoryClient {
  ...
  DefaultRepositoryClient(final GitHubClient github, final String owner, final String repo) {
    this.github = github;
    this.owner = owner;
    this.repo = repo;
  }

  static DefaultRepositoryClient create(final GitHubClient github, final String owner, final String repo) {
    return new DefaultRepositoryClient(github, owner, repo);
  }
  ...
  public String getContentPath(String path, String query) {
    ...
    return String.format(DefaultRepositoryClient.CONTENTS_URI_TEMPLATE, owner, repo, path, query);
  }
